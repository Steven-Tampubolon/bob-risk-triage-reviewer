"""
scripts/fetch_ha_core_100.py

Fetches 100 merged PRs from home-assistant/core between 2026-03-01 and 2026-08-27,
builds a diff profile for each, and saves results to data/home_assistant_100prs.json.
...
SAMPLE_SIZE = 100
PROGRESS_EVERY = 10
OUTPUT_PATH = Path(__file__).resolve().parent.parent / "data" / "home_assistant_100prs.json"
...
def main() -> None:
    ...
    # ------------------------------------------------------------------
    profiles: list[dict] = []
    errors: list[dict] = {"count": 0}  # mutable container for closure
